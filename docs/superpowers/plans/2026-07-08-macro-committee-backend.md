...
- 说明:cron 6 字段(秒 分 时 日 月 周)。macro_refresh 在 `*/15`(:00/:15/:30/:45),本 job 错峰到 **:05/:35**,仅开盘→收盘且排除午休:`0 5,35 9,10,13,14 * * 1-5` + 补 11:05(11:35 越界午休不加)。时段外真正跳过由 `run_macro_verdict` 内部门禁兜底(§8.2-H),cron 只做粗过滤。
