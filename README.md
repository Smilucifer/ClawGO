...
- **盘前观察报告** —— 面向下一交易日的图文长报告,数据打底 + AI 点评:多源舆情聚合成板块、板块资金流入榜 + 拥挤度雷达、S/A/B/C 四因子观察池分级、明日主线排序。硬数据确定性打分(评级不受 AI 影响),支持一键生成、PNG/PDF 导出、自定义权重与阈值,工作日盘前自动生成。
- **舆情采集** —— 同花顺 / 新浪 / 财联社 / 东财股吧 / 雪球五源舆情统一去重入库 + AI 归一化(摘要、情绪立场、行业映射),供盘前报告与委员会催化共读。
- **定时任务** —— 盈亏快照、事件扫描、每日报告、盘前观察报告、定期"dreaming"反思。
